...
const Topbar = () => {
  ...
  return (
    <header className="min-h-[56px] py-1.5 shrink-0 flex items-center justify-between px-4 bg-white dark:bg-[#1B1B1B]/90 backdrop-blur-xl z-40 w-full transition-colors duration-300 relative">
